...
### Making Changes
When making changes to this file, ALWAYS make the same update to CLAUDE.md in the same directory. Same applies to all scoped CLAUDE.md/AGENTS.md pairs (`web/`, `internal/`).
