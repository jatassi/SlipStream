...
function FolderLegend({ folders, usedPct }: { folders: RootFolderRef[]; usedPct: number }) {
  return (
...
function StorageBody({ volumes }: { volumes: StorageInfo[] }) {
    ...
    <div className="px-4 py-3">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <FolderLegend folders={folders} usedPct={usedPct} />
        </div>
      </div>
    </div>
  )
