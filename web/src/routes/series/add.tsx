...
function AddSeriesBody({ state }: { state: AddSeriesState }) {
  ...
  return (
    <AddSeriesConfigure
      ...
      monitorOnAdd={state.monitorOnAdd}
      setMonitorOnAdd={state.setMonitorOnAdd}
      searchOnAdd={state.searchOnAdd}
      setSearchOnAdd={state.setSearchOnAdd}
      seasonFolder={state.seasonFolder}
      setSeasonFolder={state.setSeasonFolder}
      includeSpecials={state.includeSpecials}
      setIncludeSpecials={state.setIncludeSpecials}
