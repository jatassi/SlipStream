...
import type { AddMovieInput, AddSeriesInput, Request, RequestStatus, SeasonInput } from '@/types'
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to permanently delete this request? This action cannot be
              undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={showBatchDeleteDialog} onOpenChange={setShowBatchDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to permanently delete {selectedIds.size} selected request
    ...
    <div className="hover:bg-muted/40 flex items-center gap-4 p-4">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          ...
          {request.year ? (
            <span className="text-muted-foreground text-sm">({request.year})</span>
          ) : null}
        </div>
          ...
          {isPending ? (
            <>
                ...
                <TooltipTrigger
                  render={
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={onApproveAndManualSearch}
                      disabled={isProcessing}
                    />
                  }
                >
                ...
                <TooltipTrigger
                  render={
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={onApproveAndAutoSearch}
                      disabled={isProcessing}
                    />
                  }
                >
              ...
              <Tooltip>
                <TooltipTrigger
                  render={
                    <Button variant="ghost" size="icon" onClick={onDeny} disabled={isProcessing} />
                  }
                >
