    ...
    render: (movie) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {Boolean(callbacks.onSearch) && <DropdownMenuItem onClick={() => callbacks.onSearch?.(movie.id)}>
              <Search className="mr-2 size-4" />
              Search
            </DropdownMenuItem>}
          {Boolean(callbacks.onRefresh) && <DropdownMenuItem onClick={() => callbacks.onRefresh?.(movie.id)}>
              <RefreshCw className="mr-2 size-4" />
              Refresh
            </DropdownMenuItem>}
          {Boolean(callbacks.onDelete) && <DropdownMenuItem
